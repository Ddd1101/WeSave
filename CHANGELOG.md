...
- `新增` [Server/seed.js](Server/seed.js) 初始数据脚本，写入参考表格中的 19 条资产记录（存款 10 条、投资资产 7 条、其他资产 2 条，合计 7,995,885.74 元）。
- `变更` 仓库根目录新增 [.gitignore](.gitignore)，排除 `node_modules/`、`Server/data/*.db*`、日志与环境文件，避免把依赖和数据库数据提交进仓库。
